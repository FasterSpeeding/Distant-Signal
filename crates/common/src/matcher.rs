...
mod tests {
    ...
    // choice, not a shared segment: `scotrail-fife-borders.toml` tags this
    // same station with its own plain `scotrail-fife-circle` segment name,
    // which also covers Kirkcaldy and the rest of that file's own loop --
